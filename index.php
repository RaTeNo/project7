		...
		<div class="wrap">
			<div class="main">
				...
				<section class="first_section block">
					<div class="cont">
						<div class="info">
							<div class="title">Торговая сеть <span>у вашего дома</span></div>
							...
							<div class="slider owl-carousel">
								<div class="slide">
									<div class="review">
										...
										<div class="text">
											<p>
												Индекс «Пятёрочки» рассчитывается как соотношение стоимости продовольственного набора торговой сети «Пятёрочка» рассчитываемой Росстатом
											</p>
				...
				<section class="big_boss_quote block">
					<div class="cont">
						...
						<div class="info">
							<div class="block_head">
								<div class="title">Слово <span>Руководителя</span></div>
							</div>
						...
						<div class="slider owl-carousel">
							...
							<div class="slide">
								<div class="item">
									...
									<div class="desc">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Illo cum ad iusto reiciendis suscipit vero aperiam similique voluptates molestiae, dolores distinctio, minima magni id minus fuga, facilis aspernatur ducimus alias!</div>
								</div>
							</div>
